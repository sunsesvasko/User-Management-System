...
exports.Axios = Axios;
},{"./lib/axios.js":"../../node_modules/axios/lib/axios.js"}],"editUser.js":[function(require,module,exports) {
"use strict";
...
},{"axios":"../../node_modules/axios/index.js"}],"deleteUser.js":[function(require,module,exports) {
"use strict";
...
var userRow = document.querySelectorAll('.user--row');
var newUserForm = document.querySelector('.form--user');
var editUserForm = document.querySelector('.form--edit');
if (userRow) {
  userRow.forEach(function (row) {
    row.addEventListener('click', function (e) {
      if (e.target.id === 'delete--btn' || e.target.classList.contains('fa-times')) {
        (0, _deleteUser.deleteUser)(e.target.dataset.id);
      }
      ;
    });
  });
...
if (newUserForm) {
  newUserForm.addEventListener('submit', function (e) {
    ...
    (0, _createUser.createUser)(dataObj);
  });
}
;
...
;
},{"./editUser":"editUser.js","./createUser":"createUser.js","./deleteUser":"deleteUser.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
